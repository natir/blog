...
If you work with quast to evaluate an uncorrected misassembly, you need to set `min-identity` parameter to 80 %, and I think it would be nice to have a lower minimum value, maybe 70%, but the quast code would have to be modified.
