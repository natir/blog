...
date = 2018-10-11
draft = false
tags = ["overlapper", "long-read", "compression"]
aliases = ["/2018/10/11/binary-mapping-format"]
+++
...
If you want to replicate these results, just follow the instructions avaible at [github repro](https://github.com/natir/jPAF). Full data are avaible here: [nanopore](nanopore.csv), [pacbio](pacbio.csv).
